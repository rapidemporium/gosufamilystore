...
var buyButton = document.getElementById("smileoneButton");
var quantityCounter = document.getElementById("quantityCounter");
var whatsappBtn = document.getElementById("smilewhatsappBtn");
var preventTouching = document.querySelector("#preventTouching");
var warn = document.getElementById("warn");
var rs = document.querySelector(".rs");
var inputEmail = document.getElementById("inputEmail");
var notUserMessage = document.getElementById('notUserMsg');
...
itemList.forEach(function (itemCard) {
  itemCard.addEventListener("click", function () {
    ...
    notUserMessage.style.display = "none";
  });
});
